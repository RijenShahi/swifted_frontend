    ...
    render() {
        return (
            <div className="form">
                ...
                <div>
                <Link to="/login" className="text-black-50"><Button variant="outlined" color="secondary">
                    Already have an account?</Button></Link>
                <Button id="register" variant="contained" color="secondary" onClick={this.Register}>Create Account</Button>
                </div>
